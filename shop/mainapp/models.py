...
class Product(models.Model):
    ...
    price = models.DecimalField(verbose_name="Product price", max_digits=6, decimal_places=2, default=0)
    color = models.PositiveIntegerField(verbose_name="Product color",default=0x000000)
    description = models.TextField(verbose_name="Product description", blank=True)
    image = models.ImageField(verbose_name="Product image", blank=True, upload_to="products")
